            ...
            <div class="row">
                ...
                <table class="table table-hover table-sm table-bordered">
                    ...
                    <?php
                        ...
                        $result = mysqli_query($con, "SELECT * FROM CustRepairDetails WHERE RepairCust = '$UserID' AND PaymentStatus != 'DONE'");
                        if (mysqli_num_rows($result) >= 1){
                            $result1 = mysqli_query($con, "SELECT * FROM CustRepairDetails WHERE PaymentStatus = 'NO' OR PaymentStatus = 'PENDING'");
                                    ...
                                    echo '                                
                                        <tr>
                                            <form action="PaymentProcess.php" method="post">
                                                <input type="hidden" class="form-control" value="' . $res['CustRepairID'] . '" readonly name="CustRepairID">
                                                ...
                                                <td scope="row"><textarea class="form-control" readonly name="CustRepairDesc" rows = "1">' . $res['CustRepairDesc'] . '</textarea></td>
                                                <td scope="row"><input type="text" class="form-control" value="' . $res['PaymentStatus'] . '" readonly name="PaymentStatus"></td>
                                                <td><input class="btn btn-success" type="submit" value="Pay" name="Pay"></td>
                                            </form>
                                        </tr>                                
                                    ';
                                    $Counter=$Counter+1;
