...
<html lang="en">
    <head>
		...
		<title>GMS | Mechanic Finished Jobs</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                    ...
                    $result = mysqli_query($con, "SELECT * FROM CustRepairDetails WHERE TakenByUserID = '$TakenByUserID' AND CustJobDone = 'YES'");
                        ...
                        while ($x <= mysqli_num_rows($result)) {
                            ...
                            echo '                                
                                <tr>                            
                                    ...
                                    <td scope="row">' . $res['CustJobTakenWhen'] . '</td>
